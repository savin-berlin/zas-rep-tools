...
class RepFinder(object):
    ...
    def __init__(self, inpdata, 
        ...
        self.logger = logger.myLogger("RepFinder", self._folder_for_log_files, use_logger=self._use_logger, level=logger_level)

        self.logger.debug('Beginn of creating an instance of RepFinder()')
        ...
        self.logger.debug('An instance of RepFinder() was created ')
