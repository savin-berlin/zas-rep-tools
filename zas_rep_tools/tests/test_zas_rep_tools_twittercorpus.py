...
from zas_rep_tools.src.classes.Corpus import TwitterCorpus
...
class TestZAScorpusTwitterCorpus(unittest.TestCase):
    def setUp(self):
        ...
        ######## Folders Creation ##############
        ########### Begin ######################
        path_to_zas_rep_tools = os.path.dirname(os.path.dirname(os.path.dirname(inspect.getfile(TwitterCorpus))))
