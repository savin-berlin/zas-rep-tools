...
from zas_rep_tools.src.classes.Reader import  Reader, JSONCorpusReader
...
class TestZASReaderJSONCorpusReader(unittest.TestCase):
    def setUp(self):
...
###################INITIALISATION:000############################################
    ...
    def test__025(self):
        pass
        #BloggerCorp = Corpus(self.small_subset)
