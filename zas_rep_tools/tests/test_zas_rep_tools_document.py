...
from zas_rep_tools.src.classes.Corpus import Document
...
class TestZASCorpusDocument(unittest.TestCase):
    def setUp(self):
        ...
        ######## Folders Creation ##############
        ########### Begin ######################
        path_to_zas_rep_tools = os.path.dirname(os.path.dirname(os.path.dirname(inspect.getfile(Document))))
