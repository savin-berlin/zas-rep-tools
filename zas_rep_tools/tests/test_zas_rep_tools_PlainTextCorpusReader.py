...
from zas_rep_tools.src.classes.Reader import  PlainTextCorpusReader
...
class TestZASReaderPlainTextCorpusReader(unittest.TestCase):
    def setUp(self):
        ...
        ######## Folders Creation ##############
        ########### Begin ######################
        path_to_zas_rep_tools = os.path.dirname(os.path.dirname(os.path.dirname(inspect.getfile(PlainTextCorpusReader))))
...
###################INITIALISATION:000############################################
    ...
    def test__025(self):
        ...
        BloggerCorp = PlainTextCorpusReader(self.temp_abs_path_to_small_fake_subset)
