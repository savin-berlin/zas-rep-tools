...
setup(name='zas-rep-tools',
      ...
      install_requires=[ 'sure','nose', 'rednose', 'blessings', 'testfixtures', 'click', 'regex', 'scipy', 'cached_property', 'raven', "email",  "tweepy", "nltk", "langid", "unicodecsv", "coloredlogs", "pysqlcipher", "pycrypto"],
      zip_safe=False,
